...
const features = [
  { icon: Shield, title: 'Google Sign-In', description: 'Secure, one-click authentication with your Google Business account.', color: 'from-[#00c2ff] to-[#0099cc]' },
  { icon: CreditCard, title: 'Stripe Billing', description: 'Enterprise-grade payment processing. Cancel anytime.', color: 'from-[#8b5cf6] to-[#6d28d9]' },
  { icon: BarChart3, title: 'Real-Time Dashboard', description: 'Monitor reviews and analytics in one intuitive interface.', color: 'from-[#00c2ff] to-[#8b5cf6]' },
  { icon: Zap, title: 'AI Responses', description: 'AI-powered responses generated in seconds.', color: 'from-[#8b5cf6] to-[#00c2ff]' },
  { icon: Lock, title: 'Bank-Level Security', description: 'Your data is encrypted and protected with industry-leading protocols.', color: 'from-[#00c2ff] to-[#0099cc]' },
